...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insere o nome da categoria na tabela categorias
    $sql = "INSERT INTO categorias (categoria_nome) VALUES ('$categoria_nome')";

    if ($conn->query($sql) === TRUE) {
        header("Location: categorias.php"); // Redireciona para a página de listagem de categorias
        exit();
    } else {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Cadastrar Nova Categoria</h1>
